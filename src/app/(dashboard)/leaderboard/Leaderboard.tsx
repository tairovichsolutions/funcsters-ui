            ...
            <div className=" bg-dashboard-background  text-[0F172A] relative py-10">
                ...
                {!isLoading && currentUser && (
                    <button
                        ...
                        className="fixed bottom-5 right-8 md:right-[calc((100vw-768px)/2+50px)] lg:right-[calc((100vw-1024px)/2+110px)] xl:right-[calc((100vw-1280px)/2+130px)] 2xl:right-[calc((100vw-1536px)/2+250px)] z-50 group hover:scale-110 transition-transform duration-300 drop-shadow-[0_8px_16px_rgba(59,130,246,0.4)] cursor-pointer"
                        title="Scroll to your rank"
                    >
                        {/* Outer White Hexagon */}


<svg width="98" height="76" viewBox="0 0 98 76" style={{ overflow: "visible" }} fill="none" xmlns="http://www.w3.org/2000/svg">
