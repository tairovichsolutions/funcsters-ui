...
// 1. ShareIcon updated to accept the onClick function
const ShareIcon = ({ name, onClick }: { name: string; onClick: () => void }) => (
  <div
    onClick={onClick}
    className="border p-2 cursor-pointer border-[#005092] text-[#005092] dark:text-white bg-[#0050921A] size-9 rounded-full flex justify-center items-center dark:border-[#FFFFFF] hover:bg-[#00509233] transition-colors"
  >
    ...
    >
      <div className=" space-y-5 ">
        <div className=" bg-[#E5F3FF] dark:bg-primary/15 rounded-lg flex flex-col items-center gap-6 p-4">
          ...
          <h4 className="text-[33px] leading-none font-bold text-center">
            Solution Submitted!
          </h4>
          ...
          <div className=" flex flex-col md:flex-row justify-center items-center w-full gap-6 md:gap-10">
            ...
            {xpCount > 0 && (
              <div className="bg-[#FFFAF4] dark:bg-[#FFFAF4]/15 p-3 rounded-3xl flex items-center gap-3 w-full justify-center max-w-[200px]">
                <Image
